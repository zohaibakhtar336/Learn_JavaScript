const fromAmmountElement = document.querySelector(".amount");
const convertedAmmountElement = document.querySelector(".convertedAmount");
...
// Default selected values selected
fromCurrencyElement.value = "USD";
toCurrencyElement.value = "INR";

const getExchangeRate = async () => {
    const amount = parseFloat(fromAmmountElement.value);
    ...
    try {
        ...
        if (typeof conversionRate === "undefined") {
            ...
            convertedAmmountElement.value = "";
        } else {
            convertedAmmountElement.value = convertedAmount;
